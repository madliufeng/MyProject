...
//        self.backgroundImage = [UIImage imageNamed:@"tabbar-light"];
        self.backgroundImage = [[UIImage imageNamed:@"底部框"] stretchableImageWithLeftCapWidth:25 topCapHeight:25];
//
//        // 添加发布按钮
...
- (void)layoutSubviews
{
    ...
    if (self.isNormal) {
          tabBarButtonW = width / 4;
    }else
    {
        tabBarButtonW = width/5;
    }
