...
- (void)drawRect:(CGRect)rect
{
    ...
    UILabel *selectedLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, _pageControl.frame.size.height -3, _pageControl.frame.size.width/_pageNum, 3)];    selectedLabel.backgroundColor = _tabSelectedArrowBgColor;
    ...
    //
    !self.finishedDraingAction?:self.finishedDraingAction();
}
